...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Audio Player", href: "/docs/components/audio-player" },
      { title: "Auth Card", href: "/docs/components/auth-card" },
      { title: "Cookie Banner", href: "/docs/components/cookie-banner" },
      { title: "Currency Input", href: "/docs/components/currency-input" },
      { title: "Review Card", href: "/docs/components/review-card" },
      { title: "Sparkline", href: "/docs/components/sparkline" },
      { title: "Theme Selector", href: "/docs/components/theme-selector" },
      { title: "Two Factor Setup", href: "/docs/components/two-factor-setup" },
      { title: "Video Player", href: "/docs/components/video-player" },
      { title: "Phone Input", href: "/docs/components/phone-input" },
      { title: "Address Form", href: "/docs/components/address-form" },
      { title: "Notification Bell", href: "/docs/components/notification-bell" },
      { title: "Signature Pad", href: "/docs/components/signature-pad" },
      { title: "Emoji Picker", href: "/docs/components/emoji-picker" },
      { title: "Comment Thread", href: "/docs/components/comment-thread" },
      { title: "Voice Message", href: "/docs/components/voice-message" },
    ],
  },
];
